...
const HeaderSingleCases = ({ handleOpen, headerStyle }) => {
    ...
    return (
        <>
            <header className={scroll ? `${headerStyle} header header-single-cases sticky-bar stick ` : `${headerStyle} header sticky-bar`} >
...
export default HeaderSingleCases;